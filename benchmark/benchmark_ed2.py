...
def compare_with_official(
    official_weights: Union[str, Path] = "./runs/detect/train2/weights/best.pt",
    custom_weights: Union[str, Path] = "./runs/detect/train2/weights/best.pt",  # 与 official 相同文件，但用 custom: 前缀走自定义后端
